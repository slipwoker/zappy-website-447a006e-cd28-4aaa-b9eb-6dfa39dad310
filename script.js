document.addEventListener('DOMContentLoaded', function () {
  ...
  function handleNavbarScroll() {
    ...
    if (window.scrollY > 50) {
      navbar.classList.add('navbar--scrolled', 'scrolled', 'is-scrolled');
    } else {
      navbar.classList.remove('navbar--scrolled', 'scrolled', 'is-scrolled');
    }
  }
  ...
  if (contactForm) {
    ...
    function showFieldError(field, message) {
      ...
      field.classList.remove('field--valid', 'is-valid');
      ...
      if (!errorEl) {
        ...
        errorEl.className = 'field-error form-error-message';
    ...
    function clearFieldError(field) {
      ...
      field.classList.add('field--valid', 'is-valid');
  ...
  const animationClass = 'fade-in-up';
  const visibleClass = 'is-visible';
  const animatedAttr = 'data-animate';

  // Auto-mark elements that should animate
  ...
  style.textContent = [
    '.fade-in, .fade-in-up, .fade-in-down, .fade-in-left, .fade-in-right, .scroll-animate, [data-animate], .animate-on-scroll {',
    '  opacity: 0;',
  ...
  function getAnimatableElements() {
    return Array.from(
      document.querySelectorAll(autoAnimateSelectors.join(', '))
    ).filter(function (el) {
  ...
  function revealElements() {
    ...
    elements.forEach(function (el, index) {
      if (isInViewport(el)) {
        const delay = el.dataset.animateDelay || index * 50;
        setTimeout(function () {
  ...
  if ('IntersectionObserver' in window) {
    ...
    function observeElements() {
      const elements = document.querySelectorAll(autoAnimateSelectors.join(', '));
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '447a006e-cd28-4aaa-b9eb-6dfa39dad310',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '447a006e-cd28-4aaa-b9eb-6dfa39dad310';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '447a006e-cd28-4aaa-b9eb-6dfa39dad310';
